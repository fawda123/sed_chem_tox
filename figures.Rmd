...
jpeg(here('figs', 'pcanuts.jpg'), height = 11, width = 5.5, units = 'in', res = 500, family = 'serif')
{p1 + p2 + p3 + plot_layout(ncol = 1)} - 
    pleg + plot_layout(ncol = 2, widths = c(1, 0.2))
dev.off()
```
```{r pcanuts, fig.cap = "Evaluating site groupings in Fig. 1 and the variance among measured variables using principal components analysis. Sites with similar characteristics are closer to each other in the ordination plot. Included are the measured variables related to site groupings as two-dimensional vectors. The first three PCA axes are shown, with each plot showing a different combination of axes.", out.width = "45%", fig.align = 'center'}
